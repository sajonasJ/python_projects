...
## an integer in the list is followed by the same integer. The start and end  //
## index will both be valid indexes into the list with start less than or     //
## equal to end.                                                              //
##                                                                            //
...
## (inclusive) is followed by the same integer.                               //
##   5, 3, 3, 3, 2,  2, 4 -> 1                                                //
##   5, 3, 6, 7, 2,  0, 1 -> 0                                                //
##   5, 3, 3, 3, 2,  0, 4 -> 2                                                //
##//////////////////////////////////////////////////////////////////////////////
